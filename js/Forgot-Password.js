...
$('#getMsgCode').click(function(){
	...
	$.ajax({
		type:"post",
		url:"http://www.scmqyc.com/mingqi/tp/sso/Register/getMsgCode",
		async:true,
...
$('#btn').click(function(){
	//console.log(2222);
	//声明要传递给服务器的json数据
	var postData = $('#reset').serialize();
	//AjaxPost方法传递数据
	AjaxPost('index.php/sso/login/forgetpassword',postData,succCallback,errorCallback,"post","json");
})
//登录成功后执行的方法
